...
local _fighter1_min_groups = 2 -- the minnimum available groups per squadron
...
local function setup_airwing_1 ()
    ...
    if math.random(100) < _readiness_fighter_1 then
        ...
        env.info("Squadron 1 Bandar Abbas spawned with " .. _available_fighters .. " groups and a grouping of " .. _grouping, false)
    ...
    if math.random(100) < _readiness_fighter_2 then
        ...
        local _grouping = GetFighterGroupingCount()
        env.info("Squadron 2 Bandar Abbas spawned with " .. _available_fighters .. " groups and a grouping of " .. _grouping, false)
...
local function setup_airwing_2()
    ...
    if math.random(100) < _readiness_fighter_1 then
        ...
        local _grouping = GetFighterGroupingCount()
        env.info("Squadron 3 Kish spawned with " .. _available_fighters .. " groups and a grouping of " .. _grouping, false)
